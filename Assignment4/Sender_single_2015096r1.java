...
import java.net.*;
import java.io.*;
public class Sender_single_2015096r1 {
...
//        break temp into segments
        ...
        while(true) {
            ...
            for(i=lastsent;i<lastseqnum;i++,lastsent++){
                ...
                String q =Integer.toString(packets.get(i).getSeqnum()+1);
                ff.add(q);
            ...
            while(d!=lastsent){
                try{
                    ...
                    timeout = true;
                    int ylastsent = Integer.parseInt(ff.get(0));
                    int last = Integer.parseInt(ff.get(ff.size()-1));
                    while(ylastsent <last ){
            ...
            if(windowsize >= Receiver_single_2015096r1.recwnd)
            {
                windowsize = Receiver_single_2015096r1.recwnd;
                continue;
            }
